...
const womenProducts: Product[] = [
  ...
  },
  {
    ...
    name: "Blusa Elegante",
    price: 45.99,
    image: "https://images.unsplash.com/photo-1551803091-e20673f15770?q=80&w=1200",
    category: "Blusas"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    price: 49.99,
    image: "https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?q=80&w=1200",
    category: "Faldas"
  }
];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden lg:flex space-x-8">
              <Link href="/mujer" className="text-gray-900 font-semibold">Mujer</Link>
              <Link href="/hombre" className="text-gray-700 hover:text-gray-900">Hombre</Link>
      ...
      <div className="bg-gray-100 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-gray-900">Moda Mujer</h1>
          <p className="mt-2 text-gray-600">Descubre nuestra colección para mujeres</p>
        </div>
      </div>
